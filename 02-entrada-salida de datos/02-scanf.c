...
int main()
{
    ...
    // Como podes ver, scanf necesita al menos dos parámetros
...
------------------------------------------------------------------------------------
 ...
 de formato entre comillas "separados por un espacio, ese será el primero
 argumento, después de eso, todos los argumentos siguientes serán un & seguido de
 el nombre de la variable. Si desea leer dos variables int a la vez, 
 la sintaxis será asi

 scanf("%d %d", &num1, &num2)

 Desafío: ingrese la palabra "Hola" desde el teclado letra por letra e luego imprime 
