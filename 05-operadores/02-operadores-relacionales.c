...
------------------------------------------------------------------------------------
 ...
 Para examinar la relacion entre las dos variables, se emplean 
 operadores relacionales en C.
 estos operadores devolvera el valor 1 (verdadero) si la relacion es verdadera o
...
------------------------------------------------------------------------------------
 Desafio: 
 tome la entrada del usuario y comparela con el numero 10; 
 ...
 -Ejemplo:
 - si el usuario ingreso 11, entonces la salida deberia ser "mayor".
 - Si el usuario ingreso 8, entonces la salida deberia ser "menos".
 - si el usuario ingreso 10, entonces la salida debe ser "igual".
------------------------------------------------------------------------------------
*/
